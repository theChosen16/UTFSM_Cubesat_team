...
Usa este contexto para referenciar, cuando te pregunten qué hay que hacer o cómo ayudar, tareas pendientes de los miembros, etc. Sé breve y estructurado en tus respuestas. Trata al usuario con respeto y estilo ingenieril.`
      ...
      // Usando modelo Gemini 1.5 Flash (más ligero, rápido, robusto) u optimizando para chat.
      ...
      logger.error('Error initializing AI session', { error: error instanceof Error ? error : undefined })
      return false
    }
  }
  ...
  static async sendMessage(message: string): Promise<string> {
    ...
    try {
      ...
      logger.error('Error sending message to AI', { error: error instanceof Error ? error : undefined })
